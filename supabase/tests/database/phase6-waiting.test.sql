...
-- Keep this synthetic clock outside every real launch window: the atomic bundle
-- reader intentionally chooses the live day at its supplied instant.
insert into public.journeys (
  ...
  'Phase 6 Waiting Test', '2096-09-16T00:00:00Z', 3, 'preview',
  '2096-09-16T00:00:00Z', '2096-09-16T00:00:00Z', 1, true
);
...
insert into public.country_days (
  ...
  (
    ...
    '2096-09-16T00:00:00Z', '2096-09-17T00:00:00Z', 'tashkent-v4', 'live'
  ),
  (
    '10000000-0000-4000-8000-000000000098',
    '00000000-0000-4000-8000-000000000096',
    2, 'TJ', 'Tajikistan', 'Dushanbe', 'Asia/Dushanbe',
    '2096-09-17T00:00:00Z', '2096-09-18T00:00:00Z', 'dushanbe-v1', 'scheduled'
  ),
  (
    '10000000-0000-4000-8000-000000000099',
    '00000000-0000-4000-8000-000000000096',
    3, 'KG', 'Kyrgyzstan', 'Bishkek', 'Asia/Bishkek',
    '2096-09-18T00:00:00Z', '2096-09-19T00:00:00Z', 'bishkek-v1', 'scheduled'
  );
...
select is(
  (select out_waiting_since from public.record_presence_heartbeat_v4(
    ...
    'active', true, '2096-09-16T00:00:00Z', 50, 1.8, 5, 600
  )),
  '2096-09-16T00:00:00Z'::timestamptz,
  'the first lease receives the day-start wait origin'
);
select is(
  (select out_woke_him from public.record_presence_heartbeat_v4(
    '10000000-0000-4000-8000-000000000097', repeat('a', 64), repeat('1', 64),
    'active', true, '2096-09-16T00:00:01Z', 50, 1.8, 5, 600
  )),
  false,
...
select is(
  (select out_active_viewers from public.record_presence_heartbeat_v4(
    '10000000-0000-4000-8000-000000000097', repeat('a', 64), repeat('1', 64),
    'inactive', true, '2096-09-16T00:00:10Z', 50, 1.8, 5, 600
  )),
  0::bigint,
...
select is(
  ...
  '2096-09-16T00:00:10Z'::timestamptz,
  'the zero-watcher transition records its exact heartbeat time'
);
select is(
  (select out_woke_him from public.record_presence_heartbeat_v4(
    '10000000-0000-4000-8000-000000000097', repeat('a', 64), repeat('1', 64),
    'active', true, '2096-09-16T00:10:09.999Z', 50, 1.8, 5, 600
  )),
  false,
...
begin
  perform * from public.record_presence_heartbeat_v4(
    '10000000-0000-4000-8000-000000000097', repeat('a', 64), repeat('1', 64),
    'inactive', true, '2096-09-16T00:10:10Z', 50, 1.8, 5, 600
  );
end;
$$;
select is(
  (select out_woke_him from public.record_presence_heartbeat_v4(
    '10000000-0000-4000-8000-000000000097', repeat('a', 64), repeat('1', 64),
    'active', true, '2096-09-16T00:20:10Z', 50, 1.8, 5, 600
  )),
  true,
...
select is(
  (select out_woke_him from public.record_presence_heartbeat_v4(
    ...
    'active', true, '2096-09-17T00:00:00Z', 50, 1.8, 5, 600
  )),
  false,
...
select * from public.record_presence_heartbeat_v4(
  ...
  'active', true, '2096-09-17T00:10:50Z', 50, 1.8, 5, 600
);
select is(
  (select out_waiting_since from expiry_arrival),
  '2096-09-17T00:00:50Z'::timestamptz,
...
select is(
  (select out_woke_him from public.record_presence_heartbeat_v4(
    '10000000-0000-4000-8000-000000000098', repeat('e', 64), repeat('5', 64),
    'active', true, '2096-09-17T00:10:51Z', 50, 1.8, 5, 600
  )),
  false,
...
begin
  perform * from public.record_presence_heartbeat_v4(
    ...
    'active', true, '2096-09-18T00:00:00Z', 50, 1.8, 5, 600
  );
end;
$$;
select is(
  (select out_active_viewers from public.read_journey_runtime_v5(
    '10000000-0000-4000-8000-000000000099', '2096-09-18T00:10:50Z', 50, 1.8, 5
  )),
  0::bigint,
