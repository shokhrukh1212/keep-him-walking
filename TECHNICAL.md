...
Unauthenticated post-kit API and HTML routes return 404. Post text is generated by the
pure templates in `src/lib/postkit/templates.ts`; it contains only finalized or currently
stored vote/price facts.
