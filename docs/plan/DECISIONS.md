...
| His own actions | Every four to six walking minutes, staggered between conversations, alternate eligible existing drink and photo actions without an immediate repeat. | `activity-plan.ts` |
