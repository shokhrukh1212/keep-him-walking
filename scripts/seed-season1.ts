...
import { tashkentCountryPackV5 } from "../src/content/countries/tashkent.v5";
...
const plan = buildSeason1LaunchPlan(launchAt, tashkentCountryPackV5, foundingPriceCents);
