...
const names = [
  ...
  "PHASE2_REHEARSAL_SCALE", "PHASE2_REHEARSAL_MODE", "PHASE2_SUPABASE_PROJECT_REF", "POSTCARD_UNLOCK_SECONDS", "PASSPORT_COLLECT_SECONDS", "POSTCARD_RETENTION_DAYS",
  "SUPABASE_POSTCARDS_BUCKET", "SUPABASE_SPONSOR_PRIVATE_BUCKET", "SUPABASE_SPONSOR_PUBLIC_BUCKET", "SPONSOR_RESERVATION_MINUTES",
  "SPONSOR_FLOOR_CENTS", "SPONSOR_CENTS_PER_UNIQUE", "SPONSOR_FOUNDING_CENTS", "SPONSOR_CAP_CENTS",
  "SPONSOR_PREMIUM_MULTIPLIER", "SPONSOR_WINDOW_DAYS",
