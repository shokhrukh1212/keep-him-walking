...
process.stdout.write(`${JSON.stringify({ projectRef: identity.projectRef, operation: apply ? "apply-additive-migrations-007-011" : "list-migrations", productionModified: false, apply })}\n`);
const command = apply
