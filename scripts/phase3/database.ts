...
process.stdout.write(`${JSON.stringify({ projectRef: identity.projectRef, operation: apply ? "apply-additive-phase3-migrations-007-010" : "list-migrations", productionModified: false, apply })}\n`);
const command = apply
