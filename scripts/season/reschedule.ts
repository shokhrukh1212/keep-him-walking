 ...
 *
 * Its seven cities stay; every day, departure beat and ballot moves by the same amount.
...
process.stdout.write(`${JSON.stringify({
  ...
  to: { startsAt: startsAt.toISOString(), endsAt: new Date(startsAt.getTime() + 168 * 3_600_000).toISOString() },
