...
const plan = { target: "1000 concurrent watchers", watchers, durationSeconds, scenarios: ["bootstrap", "presence", "vote-validation", "postcard-validation", "sponsor-redirect-if-configured"], budgets: { p95Ms: 800, errorRate: 0.01 }, protectedPreviewBypass: Boolean(protectionBypass), mutatesState: execute };
