 ...
 *
 *   pnpm assets:verify --pack paris-v2 --base https://assets.keephimwalking.lol
...
const origin = argument("--origin") ?? process.env.PRODUCTION_APP_URL ?? "https://keephimwalking.lol";
