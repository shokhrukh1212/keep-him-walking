  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>One featured sponsorship is sold through the service at a price the server names: the first sponsor pays USD 50.00, and each replacement pays twice the price the current sponsor paid while the sponsor it replaces is refunded in full. Payment is taken by Dodo Payments, and a placement exists only once that processor confirms the payment. Any sponsor placement that is shown is advertising and may be removed under the moderation policy, but Keep Him Walking does not guarantee or endorse a sponsor, its claims, products or destination. External websites are controlled by their operators. Report concerns through <Link href="/contact">Contact &amp; support</Link>. Sponsorship is described in the <Link href="/sponsor-terms">Sponsor Terms</Link> and <Link href="/content-moderation">Content and Listing Moderation Policy</Link>.</p>
