...
import { DEFAULT_DATAFAST_PUBLIC_DASHBOARD_URL, publicDatafastDashboardUrl } from "@/lib/analytics/datafast";
...
export default async function HomePage() {
  return <JourneyExperience
    ...
    datafastDashboardUrl={publicDatafastDashboardUrl(
      process.env.DATAFAST_PUBLIC_DASHBOARD_URL ?? DEFAULT_DATAFAST_PUBLIC_DASHBOARD_URL,
    )}
