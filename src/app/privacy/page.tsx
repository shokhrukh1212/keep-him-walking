  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>The optional Buy Me a Coffee link opens the operator&apos;s profile on Buy Me a Coffee; its site handles that contribution. For acknowledgment review, Keep Him Walking may import the transaction date, exact coffee count when the export supplies one, display name, email, payment identifier and private message into a protected ledger. Email, payment identifiers and messages are not published. A display name and separately verified X or startup link appear in Supporters only after the contribution is verified and the supporter has permitted acknowledgment on this separate website. Anonymous acknowledgments do not expose those links.</p>
      </section>
      ...
      <section>
        ...
        <p>No fixed deletion period is configured for sponsor requests, approved sponsor material, supporter contribution records, payment records, aggregate sponsor metrics, corrections, operational incidents or vendor logs. They are kept as needed to review submissions, deliver and document the placement or acknowledgment, handle refunds or disputes, maintain security and meet legal obligations. A public supporter acknowledgment can be corrected, unpublished or removed. Contact support to request access, correction or deletion; some transaction or security records may have to be retained.</p>
