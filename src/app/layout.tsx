...
export const metadata: Metadata = {
  ...
  title: "Keep Him Walking — Getting ready in Paris",
  description: "A virtual traveler is getting ready in Paris for a fourteen-day journey. Once launched, he walks only while someone is watching.",
