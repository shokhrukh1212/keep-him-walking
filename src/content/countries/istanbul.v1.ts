...
export const istanbulCountryPackV1 = createPhase2CountryPack({
  packId: "istanbul-v1", countryCode: "TR", countryName: "Türkiye", cityName: "Istanbul", timeZone: "Europe/Istanbul",
  zones: [
  ...
  postcardTitle: "The Bosphorus crossing", postcardCopy: "We kept the traveler moving all the way to Istanbul and the Bosphorus.",
